...
client.channels.find('id', '500003722232070144').setName(",");
client.channels.find('id', '500003722232070144').setName(",R");
client.channels.find('id', '500003722232070144').setName(",Ri");
client.channels.find('id', '500003722232070144').setName(",Rit");
client.channels.find('id', '500003722232070144').setName(",Ritu");
client.channels.find('id', '500003722232070144').setName(",Ritua");
client.channels.find('id', '500003722232070144').setName(",Ritual");
client.channels.find('id', '500003722232070144').setName(",Ritual $");
client.channels.find('id', '500003722232070144').setName(",Ritual $W");
client.channels.find('id', '500003722232070144').setName(",Ritual $Wo");
client.channels.find('id', '500003722232070144').setName(",Ritual $Wor");
client.channels.find('id', '500003722232070144').setName(",Ritual $Worl");
client.channels.find('id', '500003722232070144').setName(",Ritual $World.");
  }, 3000);
});
...
client.on('message', message => { 
  var whitelisted = "452379478618800129"// ايديك
...
client.on('message', message => {
if (message.content.startsWith('.اelp')) { /// This is The DMS Code Send The Help In DMS // Code By NotGucci
    let pages = [`
༺▇༻༺▇༻༺▇༻༺▇༻༺▇༻༺▇༻༺▇༻༺▇༻
